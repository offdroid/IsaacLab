...
for seed in "${seeds[@]}"; do
  ...
  ./isaaclab.sh -p source/standalone/workflows/rsl_rl/train.py --task Isaac-Velocity-AMPStairs-Unitree-Go2-v0 --headless --seed $seed --log_dir "${datetime}_stairs_curr0-20_dsslow_dist2stairsv1_stumble-5_slide-5_standstill-1_norelativeposobs_consttorqpen_calfthighpen_nocl" --logger wandb --log_project_name amp_dr --max_iterations 20000 --num_envs 4096
