...
for seed in "${seeds[@]}"; do
  ...
  ./isaaclab.sh -p source/standalone/workflows/rsl_rl/train.py --task Isaac-Velocity-AMPStairs-Unitree-Go2-v0 --headless --seed $seed --log_dir "${datetime}_stairs_curr0-20_dsslowx2_dist2stairsv1_torqschedule_stumble-10_slide-5_standstill-1" --logger wandb --log_project_name amp_dr --max_iterations 20000 --num_envs 4096
