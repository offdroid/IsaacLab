...
for seed in "${seeds[@]}"; do
  ./isaaclab.sh -p source/standalone/workflows/rsl_rl/train.py --task Isaac-Velocity-AMPShortStairs-Unitree-Go2-v0 --headless --seed $seed --log_dir "${datetime}_amp_basic_v3slow_task0.25" --logger wandb --log_project_name amp_v3slow_task0.25_final --max_iterations 20000 --num_envs 4096
