...
for seed in "${seeds[@]}"; do
  ...
  ./isaaclab.sh -p source/standalone/workflows/rsl_rl/train.py --task Isaac-Velocity-AMPStairs-Unitree-Go2-v0 --headless --seed $seed --log_dir "${datetime}_ampDRv2_DSfaster_tryoldcfg_1stairs1walk" --logger wandb --load_run "2025-09-29_18-02-55_ampDRv2_DSfasternoslow_tryoldcfg_SEED_1" --resume true --checkpoint model_19996.pt --log_project_name amp_dr --max_iterations 20000 --num_envs 4096
