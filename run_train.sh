...
for seed in "${seeds[@]}"; do
  ...
  ./isaaclab.sh -p source/standalone/workflows/rsl_rl/train.py --task Isaac-Velocity-AMPStairs-Unitree-Go2-v0 --headless --seed $seed --log_dir "${datetime}_ampDRv2_DSfasternoslow_tryoldcfg" --logger wandb --log_project_name amp_dr --max_iterations 20000 --num_envs 4096
