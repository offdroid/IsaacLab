...
for seed in "${seeds[@]}"; do
  ./isaaclab.sh -p source/standalone/workflows/rsl_rl/train.py --task Isaac-Velocity-AMPShortStairs-Unitree-Go2-v0 --headless --seed $seed --log_dir "${datetime}_amp_basic_nocurr" --logger wandb --log_project_name amp_nocurr_final --max_iterations 5000 --num_envs 4096
