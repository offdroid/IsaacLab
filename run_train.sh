...
for seed in "${seeds[@]}"; do
  ...
  ./isaaclab.sh -p source/standalone/workflows/rsl_rl/train.py --task Isaac-Velocity-AMPStairs-Unitree-Go2-v0 --headless --seed $seed --log_dir "${datetime}_debug_v5_entropy0.01_task0.5_DSfaster_noslowDS" --logger wandb --log_project_name debug_dsv2 --max_iterations 10000 --num_envs 4096
