...
for seed in "${seeds[@]}"; do
  ...
  ./isaaclab.sh -p source/standalone/workflows/rsl_rl/train.py --task Isaac-Velocity-AMPStairs-Unitree-Go2-v0 --headless --seed $seed --log_dir "${datetime}_stairs_curr0-20_dsslow_noisyparams_flexstepwidth_stairnoise-wh_dist2stairsv2_noyaw_torqschedule_100airtime_slower_entropy0.001_standingenv0.05_stumble-5schedule" --logger wandb --log_project_name amp_dr --max_iterations 20000 --num_envs 4096
