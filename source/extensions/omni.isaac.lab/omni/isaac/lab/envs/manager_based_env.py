...
from omni.isaac.lab.managers import * # Import all action managers (pollutes namespace!)
...
class ManagerBasedEnv:
    ...
    * **Event Manager**: The event manager orchestrates operations triggered based on simulation events.
    ...
    def load_managers(self):
        ...
        # -- action manager
        action_manager_class = globals()[self.cfg.action_manager_class]
        self.action_manager = action_manager_class(self.cfg.actions, self)
